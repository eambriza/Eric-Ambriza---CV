    ...
    <div className="flex items-center justify-center min-h-[70vh]">
      <div className="text-center space-y-8">
        ...
        <div className="flex items-center justify-center min-h-[2rem]">
          ...
          <span className={`ml-2 text-accent-orange text-2xl md:text-3xl font-light transition-opacity duration-100 ${showCursor ? 'opacity-100' : 'opacity-0'}`}>
            |
          </span>
        </div>
        ...
        <div className="min-h-[3rem] flex items-center justify-center">
          <p className="text-text-secondary text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
            ...
            {typedText.length < fullText.length && (
              <span className={`text-accent-orange ${showCursor ? 'opacity-100' : 'opacity-0'} transition-opacity duration-100`}>
                |
              </span>
            )}
          </p>
