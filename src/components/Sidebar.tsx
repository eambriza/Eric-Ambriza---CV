...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`fixed inset-y-0 left-0 z-40 w-64 bg-dark border-r border-border transform transition-transform duration-300 ease-in-out lg:translate-x-0 ${
      ...
      >
        <div className="flex flex-col h-full p-6">
          ...
          <div className="mb-8">
            <Link
              href="/"
              className="text-2xl font-display font-bold text-light hover:text-accent-cyan transition-colors"
            >
              Eric Ambriza
            </Link>
